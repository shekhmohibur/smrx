          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              <p className="text-lg text-neutral-500 leading-relaxed">
                ...
                Rangpur Polytechnic Institute. My passion lies in bridging the
                gap between design and technology.
              </p>
              <p className="text-lg text-neutral-500 leading-relaxed">
                I specialize in building responsive, accessible, and animated
                web applications using the MERN stack. I believe that every
                interaction should be meaningful and every pixel should have a
                purpose.
              </p>
        ...
        >
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-center mt-6 text-neutral-500 text-sm italic">
              *Click the video to watch my story and learn more about my journey
              as a developer.*
            </p>
          </div>
        </section>
              ...
              >
                ...
                <div className="aspect-video bg-neutral-500/10 overflow-hidden relative">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                    <button
                      onClick={() =>
                        handlePreview(project.demoUrl, project.title)
                      }
        ...
        <footer className="py-12 px-6 border-t border-neutral-500/10 text-center">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="text-sm text-neutral-500">
              © 2026 Shekh Mohibur Rahman. Learning from mistakes and building
              the future.
            </div>
